...
class IssueType
{
    ...
    public function create($id, $issueTypeName, $description, $issueFee, $issueLevel, $issueType, $active, $dispatch, $handheld, $webUsers, $autoClose, $checkPointOnly, $addTo)
    {
        ...
        try {
            ...
            if ($conn->connect_error) {
                echo " Connection to the database was unsuccessfull ";
                return false;
            }
    ...
    public function update($id, $description, $issueFee, $issueLevel, $active, $dispatch, $handheld, $webUsers, $autoClose, $checkPointOnly)
    {
        ...
        try {
            ...
            updatedAt = '$currentDateTime' WHERE (issue_type_id = '$id');";
